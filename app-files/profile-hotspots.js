...
var STATIC_PROFILES = [
  ...
  },
  {
    ...
    image: "profile/38.webp",
    location: "MMAJ Academy of International Studies"
  },
  {
    id: 39,
    name: "Uzma Sheikh",
  ...
  },
  {
    ...
    image: "profile/40.webp",
    location: "Mohibbul Hasan"
  },
  {
    id: 41,
    name: "Shayan Ahmad",
  ...
  },
  {
    ...
    image: "profile/42.webp",
    location: "AJK Mass Communication"
  },
  {
    id: 43,
    name: "Ishika Gupta",
  ...
  },
  {
    ...
    image: "profile/46.webp",
    location: "Faculty of Law & Management Studies"
  },
  {
    id: 47,
    name: "Mobeen Ansari",
  ...
  },
  {
    ...
    image: "profile/51.webp",
    location: "India Arab Cultural Centre"
  },
  {
    id: 52,
    name: "Shakir Mahmood",
  ...
  },
  {
    ...
    image: "profile/57.webp",
    location: "Deen Dayal Upadhyay Kaushal Kendra"
  },
  {
    id: 58,
    name: "Aleena Javed",
  ...
  },
  {
    ...
    image: "profile/59.webp",
    location: "Centre for Physiotherapy"
  },
  {
    id: 60,
    name: "Sofia Khan",
...
var locationPins = {
  ...
  // --- New scenes (loc1..loc11) — placeholder names, rename to real dept names ---
  "Faculty of Humanities":                   { sceneId: "14-loc1",  yaw: -1.4,  pitch: -0.4 },
  "Centre for Physiotherapy":                { sceneId: "16-loc3",  yaw: 1.4,  pitch: -0.4 },
  "Deen Dayal Upadhyay Kaushal Kendra":      { sceneId: "17-loc4",  yaw: 1.4,  pitch: -0.4 },
  "Faculty of Engineering":                  { sceneId: "18-loc5",  yaw: 1.4,  pitch: -0.4 },
  "Faculty of Architecture":                 { sceneId: "18-loc5",  yaw: -1.4, pitch: -0.4 },
  "India Arab Cultural Centre":              { sceneId: "19-loc6",  yaw: -0.1,  pitch: -0.4 },
  "Faculty of Law & Management Studies":     { sceneId: "20-loc7",  yaw: 1.4,  pitch: -0.4 },
  "MMAJ Academy of International Studies":   { sceneId: "21-loc8",  yaw: 0.4,  pitch: -0.4 },
  "Mohibbul Hasan":                          { sceneId: "22-loc9",  yaw: 2.9,  pitch: -0.4 },
  "AJK Mass Communication":                  { sceneId: "24-loc11", yaw: 3.5,  pitch: -0.4 }
};
...
function createProfileStickerElement(profileList) {
  ...
  // PERF FIX: hint the browser to defer loading this image until it's near
  // the viewport, and to decode it off the main thread instead of blocking
  // scroll/pan. Without this, every hotspot's photo (across ALL 25 scenes)
  // starts downloading the moment the tour loads, which is what caused the
  // scroll/pan lag.
  img.loading = 'lazy';
  img.decoding = 'async';
