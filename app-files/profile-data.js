var profiles = [
  // =============================================
  // Department of Economics (10 profiles)
  // =============================================
  ...
  // =============================================
  // Commerce Department (6 profiles)
  // =============================================
  {
    id: 17,
    name: "Salman Akhtar",
  ...
  // =============================================
  // Department of Mathematics (8 profiles)
  // =============================================
  {
    id: 53,
    name: "Hanzala Khan",
...
// sceneId values come directly from this project's data.js.
// yaw/pitch default to 0,0 (the camera's initial look direction
// for almost every scene in this project — see initialViewParameters
// in data.js), so the sticker is visible the moment the scene loads.
// Nudge yaw left/right (radians, roughly -3.14 to 3.14) and pitch
// up/down (roughly -1 to 1) to move it to an exact spot.
// ==========================================
var locationPins = {
